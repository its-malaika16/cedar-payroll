      ...
      <div className="support-container">
        ...
        <div className="support-grid">
          ...
          <div className="support-card">
            ...
            <p>We're here to help with your payroll, HR, and workforce management requirements. </p>
            ...
            <p> For fast and convenient assistance, access our online support portal where you can:</p>
            ...
            <p> Be sure to visit our client community and resource centre, featuring:</p>
          ...
          <div className="support-card">
            ...
            <p> If you are an employee using your organization's payroll, HR, or workforce management platform, there are several ways to get assistance.</p>
            ...
            <p> Your employer may also provide access to employee self-service resources, including:</p>
